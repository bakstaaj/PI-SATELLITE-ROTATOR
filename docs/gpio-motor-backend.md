...
GPIO output is digital on/off through pinctrl in v1. PWM speed control is intentionally left for a later milestone after direction and fail-safe stopping are verified on real hardware.
